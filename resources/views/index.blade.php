...
<head>
  ...
  <link rel="shortcut icon" href="favicon.png">
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" href="{{ asset('assets/css') }}/style_landingpage.css">
  ...
  <body>
    ...
    <div class="untree_co--site-wrap">
        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="icons-wrap text-md-right">
            ...
            <form action="{{ route('logout') }}" method="post">
              @csrf
              <button type="submit" class="btn px-3 text-white" style="margin-right: 15px;font-size: 0.9rem;line-height:30px; background-color: #ff392e;">Logout</button>
            </form>
            @endauth
            @guest
              <a href="{{ route('login') }}" class="btn btn-black px-3 text-white" style="margin-right: 15px;font-size: 0.9rem;line-height:30px;">Sign In</a>
            @endguest
          </div>
        </div>
      </nav>
      ...
      <div class="untree_co--site-main">
        ...
        <div class="owl-carousel owl-hero">
          ...
          <div class="untree_co--site-hero overlay" style="background-image: url('assets/img/slider_2.jpg')">
            <div class="container">
          ...
          <div class="untree_co--site-hero overlay"  style="background-image: url('assets/img/slider_1.jpg')">
            <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                  <div class="site-hero-contents text-center" data-aos="fade-up">
          ...
          <div class="untree_co--site-hero overlay" style="background-image: url('assets/img/img_1.jpg')">
            <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="col-md-10">
                  <div class="site-hero-contents text-center" data-aos="fade-up">
              ...
              <div class="suite">
                <div class="image-stack">
                  <div class="image-stack-item image-stack-item-top" data-jarallax-element="-50">
                    ...
                    <img src="{{ asset('assets') }}/img/room_1_a.jpg" alt="Image" class="img-fluid pic1">
                  </div>
                  <div class="image-stack-item image-stack-item-bottom">
                    <div class="overlay"></div>
                    <img src="{{ asset('assets') }}/img/room_1_b.jpg" alt="Image" class="img-fluid pic2">
                  </div>
                </div>
              </div> <!-- .suite -->
              ...
              <div class="suite">
                <div class="image-stack">
                  <div class="image-stack-item image-stack-item-top">
                    <div class="overlay"></div>
                    <img src="{{ asset('assets') }}/img/room_2_a.jpg" alt="Image" class="img-fluid pic1">
                  </div>
                  <div class="image-stack-item image-stack-item-bottom" data-jarallax-element="-50">
                    <div class="overlay"></div>
                    <img src="{{ asset('assets') }}/img/room_2_b.jpg" alt="Image" class="img-fluid pic2">
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            ...
            <div class="row custom-row-02192 align-items-stretch">
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/parking.svg" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/internet.svg" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/wifi.svg" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/elevator.svg" alt="Image" class="img-fluid">
                  </div>
                  <h3>Elevators</h3>
                  <p>A hotel is an establishment that provides paid lodging on a short-term basis. Facilities provided may range from a modest-quality.</p>
                  <p><p><a href="#" class="readmore reverse">Read More</a></p></p>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/partners.svg" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="{{ asset('assets') }}/img/svg/washing-machine.svg" alt="Image" class="img-fluid">
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
                  <a href="#" class="thumb"><img src="{{ asset('assets') }}/img/img_1.jpg" alt="Image" class="img-fluid"></a>
              ...
              <div class="col-md-4">
                <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
                  <a href="#" class="thumb"><img src="{{ asset('assets') }}/img/img_3.jpg" alt="Image" class="img-fluid"></a>
                  <div class="post-entry-contents">
                    <h3><a href="#">How algorithms shape our world</a></h3>
                    <div class="date">December 20, 2019 &bullet; by <a href="#">Joefrey Mahusay</a></div>
                    <p>A hotel is an establishment that provides paid lodging on a short-term basis.</p>
        ...
        <div class="container">
          ...
          <div class="row mt-5 pt-5 align-items-center">
            <div class="col-md-6 text-md-left">
              ...
              <p>
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="#">Untree.co</a>. All Rights Reserved. Design by <a href="https://untree.co/" target="_blank" class="text-primary">Untree.co</a>
              </p>
            <!-- Link back to Untree.co can't be removed. Template is licensed under CC BY 3.0. If you purchased a license you can remove this. -->
            </div>
    ...
    <script src="{{ asset('assets') }}/js/main_landingpage.js"></script>
  </body>
</html>